...
export const dom = {
  ...
  abandonmentRecentList: document.getElementById("abandonmentRecentList"),
  abandonmentAlltimeList: document.getElementById("abandonmentAlltimeList"),
  abandonmentRecentStatus: document.getElementById("abandonmentRecentStatus"),
  abandonmentAlltimeStatus: document.getElementById("abandonmentAlltimeStatus"),
  ...
  passkeyLogin: document.getElementById("passkeyLogin"),
  passkeyLoginButton: document.getElementById("passkeyLoginButton"),
  passkeyPrompt: document.querySelector('[data-passkey-prompt]'),
  passkeyUnavailable: document.getElementById("passkeyUnavailable"),
  passwordLogin: document.getElementById("passwordLogin"),
  passwordLoginFallback: document.getElementById("passwordLoginFallback"),
