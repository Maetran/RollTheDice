export const EN = {
    ...
    "Separater Spielmodus mit sechs Würfeln und Ziel 10’000. Die Spielregeln und Wertung sind bewusst noch nicht festgelegt.": "A separate game mode with six dice and a target of 10,000. The game rules and scoring are intentionally not decided yet.",
    ...
    "Fundament, keine Regeln": "Foundation, not rules",
    "Würfeln, wertende Würfelauswahl und manuelle Punkteingabe sind hier nur als klar abgegrenztes Scaffold vorbereitet. Diese Vorschau löst keine ZDWA-Erfolge, Statistiken oder Leaderboards aus.": "Rolling, scoring-die selection and manual score entry are prepared here only as a clearly separated scaffold. This preview does not trigger ZDWA achievements, statistics or leaderboards.",
    ...
    "Gesamtpunkte": "Total points",
    "Eigenes Zilch-Board — die Wertungsfelder folgen erst nach bestätigten Hausregeln.": "Dedicated Zilch board — scoring fields will follow only after the house rules are confirmed.",
    "Zilch-Spiel wird geladen …": "Loading Zilch game …",
    "Zilch-Spielraum": "Zilch game room",
    "Ziel": "Target",
    "Sechs Würfel": "Six dice",
    "Würfel": "Die",
    "Zilch-Würfeln ist im Fundament noch nicht implementiert.": "Zilch rolling is not implemented in the foundation yet.",
    "Würfeln": "Roll",
    "Zilch-Punkteingabe ist im Fundament noch nicht implementiert.": "Zilch score entry is not implemented in the foundation yet.",
    "Punkte eintragen": "Enter score",
    "Scaffold aktiv: Keine Zilch-Wertung, keine automatischen Punkte und keine ZDWA-Logik.": "Scaffold active: no Zilch scoring, no automatic points and no ZDWA logic.",
