export const EN = {
    ...
    "Dein Achievement-Rang wird aus deinen Erfolgspunkten berechnet und erscheint mit einem Sternabzeichen neben deinem Namen – in Lobby, Spielraum, Chat, Profilen, Ergebnisansichten und Ranglisten. Die Stufen reichen von Newbie bis Godmode; wenn der Erfolgskatalog wächst, skalieren die Punktschwellen proportional mit.": "Your achievement rank is calculated from your achievement points and appears with star insignia beside your name—in the lobby, game room, chat, profiles, game views, and rankings. The tiers range from Newbie to Godmode; when the achievement catalog grows, the point thresholds scale proportionally.",
    "Newbie": "Newbie",
    "Rookie": "Rookie",
    ...
    "Entdecke das ZDWA Spieler-Ranking, suche öffentliche Profile und vergleiche Spiele, Bestwerte und Erfolgspunkte für Normal und Hardcore.": "Discover the ZDWA player ranking, find public profiles, and compare games, best scores, and achievement points for Normal and Hardcore.",
    "Spieler finden und Leistungen sowie Erfolgspunkte in Normal- und Hardcore-Partien vergleichen.": "Find players and compare performances and achievement points in Normal and Hardcore games.",
    "Finde öffentliche Spielerprofile und vergleiche Spiele, Durchschnitt, Trend, Bestwerte und Erfolgspunkte getrennt nach Normal- und Hardcore-Modus.": "Find public player profiles and compare games, averages, trends, best scores, and achievement points separately for Normal and Hardcore modes.",
    ...
    "Mit einem optionalen Konto sammelst du Erfolge für besondere Spielzüge, Serien, besondere Endergebnisse, Mehrspieler-Siege und Hardcore-Leistungen. Jeder Erfolg ist je nach Schwierigkeit 1 bis 10 Erfolgspunkte wert.": "With an optional account, you earn achievements for special plays, streaks, special final scores, multiplayer wins, and Hardcore performances. Each achievement is worth 1 to 10 Achievement Points depending on its difficulty.",
    ...
    "Erfolge verändern keine Spielregeln oder Wertungen. Deinen Fortschritt und deine Erfolgspunkte siehst du im Konto; die Spielerübersicht enthält ein eigenes Erfolgs-Ranking.": "Achievements do not change the rules or scoring. You can see your progress and Achievement Points in your account; the player overview has a dedicated achievement ranking.",
    ...
    "Erfolgspunkte": "Achievement Points",
    "Meiste Erfolgspunkte": "Most Achievement Points",
